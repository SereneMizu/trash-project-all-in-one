...
public class JwtUtils {
    public static final long EXPIRE_TIME = (long) 1000 * 60 * 60 * 24 * 600;
    ...
    public static String sign(User userInfo) {
        ...
        return JWT.create()
                ...
                .withClaim("name", userInfo.getUserName())
    ...
    public static TokenModel getTokenModelByToken(String token) {
        ...
        tokenModel.setId(decodedJWT.getClaim("user_id").asInt());
        tokenModel.setUsername(decodedJWT.getClaim("username").asString());
        return tokenModel;
    }
