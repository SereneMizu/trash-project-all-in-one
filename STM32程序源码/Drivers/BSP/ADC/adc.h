...
#define ADC_ADCX_CHX_GPIO_PORT              GPIOF
#define ADC_ADCX_CHX_GPIO_PIN               GPIO_PIN_8

#define ADC_ADCX_CHY_GPIO_PORT              GPIOF
#define ADC_ADCX_CHY_GPIO_PIN               GPIO_PIN_9

#define ADC_ADCX_CHY_GPIO_CLK_ENABLE()      do{ __HAL_RCC_GPIOF_CLK_ENABLE(); }while(0)  /* PA口时钟使能 */

#define ADC_ADCX_CHY                        ADC_CHANNEL_7
#define ADC_ADCX                            ADC3 
#define ADC_ADCX_CHX                        ADC_CHANNEL_6                      /* 通道Y,  0 <= Y <= 17 */ 
