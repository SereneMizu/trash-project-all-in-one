...
void HAL_ADC_MspInit(ADC_HandleTypeDef *hadc)
{
    if(hadc->Instance == ADC_ADCX)
    {
        ...
        HAL_GPIO_Init(ADC_ADCX_CHY_GPIO_PORT, &gpio_init_struct);
				gpio_init_struct.Pin = ADC_ADCX_CHX_GPIO_PIN;             /* ADC通道IO引脚 */
        gpio_init_struct.Mode = GPIO_MODE_ANALOG;                 /* 模拟 */
        HAL_GPIO_Init(ADC_ADCX_CHX_GPIO_PORT, &gpio_init_struct);
				HAL_GPIO_WritePin(ADC_ADCX_CHY_GPIO_PORT,ADC_ADCX_CHY_GPIO_PIN,GPIO_PIN_RESET);
				HAL_GPIO_WritePin(ADC_ADCX_CHX_GPIO_PORT,ADC_ADCX_CHY_GPIO_PIN,GPIO_PIN_RESET);
    }
}
